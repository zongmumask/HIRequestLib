...
//_kaas_
#  define EVP_PKEY_CTRL_SET_PEER_ID                      (EVP_PKEY_ALG_CTRL + 14)
#  define EVP_PKEY_CTRL_SET_SELF_ID                      (EVP_PKEY_ALG_CTRL + 15)
#  define EVP_PKEY_CTRL_SET_PEER_ECDHE                   (EVP_PKEY_ALG_CTRL + 16)
#  define EVP_PKEY_CTRL_SET_SELF_ECDHE                   (EVP_PKEY_ALG_CTRL + 17)
#  define EVP_PKEY_CTRL_SET_PEER_PUB                     (EVP_PKEY_ALG_CTRL + 18)
#  define EVP_PKEY_CTRL_SET_SELF_PUB                     (EVP_PKEY_ALG_CTRL + 19)
...
#  define EVP_PKEY_CTX_set_sm2_peer_pub(ctx, pub) \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_SM2, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_SET_PEER_PUB, 0, (void *)pub)

#  define EVP_PKEY_CTX_set_sm2_self_pub(ctx, pub) \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_SM2, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_SET_SELF_PUB, 0, (void *)pub)
...
typedef struct {
    ...
    EC_KEY *peer_ecdhe_pub;
    /* self ephemeral key(pub+pri) */
    EC_KEY *self_ecdhe_pair;
