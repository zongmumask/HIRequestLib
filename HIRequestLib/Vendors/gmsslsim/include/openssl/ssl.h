...
# define SSL_OP_NO_GMv1_1                                0x00000001U
...
__owur const SSL_METHOD *GMSSLv1_1_server_method(void);

//2021.01.27
__owur const SSL_METHOD *GMSSLv1_1_client_method(void);
...
//2020.10.27
# define SSL_CTRL_SET_SNI_ZERO  200
# define SSL_set_SNI_zero(s, flags) SSL_CTX_ctrl(s, SSL_CTRL_SET_SNI_ZERO, flags, NULL)

void GM_init(void);
int GM_SSL_CTX_use_sig_certificate_file(SSL_CTX *ctx, const char *file);
int GM_SSL_CTX_use_enc_certificate_file(SSL_CTX *ctx, const char *file);
int GM_SSL_CTX_use_sig_PrivateKey_file(SSL_CTX *ctx, const char *file);
int GM_SSL_CTX_use_enc_PrivateKey_file(SSL_CTX *ctx, const char *file);
void GM_SSL_CTX_set_client_CA_file(SSL_CTX *ctx, const char *file);

int GM_SSL_CTX_use_sig_certificate(SSL_CTX *ctx, X509 *cert);
int GM_SSL_CTX_use_enc_certificate(SSL_CTX *ctx, X509 *cert);
int GM_SSL_CTX_use_sig_PrivateKey(SSL_CTX *ctx, EVP_PKEY *pkey);
int GM_SSL_CTX_use_enc_PrivateKey(SSL_CTX *ctx, EVP_PKEY *pkey);

STACK_OF(X509_NAME) *GM_SSL_CTX_get_client_CA_list(const SSL_CTX *ctx);

int GM_sm2_key(EVP_PKEY *pkey);
int GM_sm2_crt(X509* cert);
int GM_sm2_enc(X509* cert);
...
typedef struct MYSDP_st MYSDP;
int SSL_set_sdp(SSL_CTX *ctx, char *gid, char *key);
